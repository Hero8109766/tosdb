...
export class EntityDetailAttackDefenseComponent extends EntityDetailChildComponent implements OnChanges {
    ...
    anvilATK: number = 0;
    anvilDEF: number = 0;
    goddessAnvilATK: number = 0;
    goddessAnvilDEF: number = 0;
    ...
    ngOnChanges(changes: SimpleChanges) {
        ...
        if (changes.goddessAnvilLevel && this.equipment) {
            this.goddessAnvilATK = this.equipment.AnvilATK(this.goddessAnvilLevel);
            this.goddessAnvilDEF = this.equipment.AnvilDEF(this.goddessAnvilLevel);
        }
